...
class LLMClient:
    ...
    def system_prompt(self, facts, fallback):
        return (
            "Ты ассистент АХО. Отвечай по-русски, кратко и понятно. "
            "Используй только факты ниже и безопасный черновик ответа. "
            "Не добавляй новых регламентов, цен, сроков или обещаний. "
            "Если данных не хватает, верни один прямой уточняющий вопрос пользователю. "
            "Не объясняй, почему поле нужно заполнить. "
            "Не проси ссылки, если в безопасном черновике запрошено количество, офис или срочность. "
            "Сохраняй ссылку на источник, если она есть в черновике. "
            f"Факты:\n{facts}\n\n"
